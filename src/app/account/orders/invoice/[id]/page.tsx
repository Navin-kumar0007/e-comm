...
export default async function CustomerInvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20 pt-8">
      ...
      <div className="bg-white text-black p-8 sm:p-12 rounded-xl shadow-sm border print:shadow-none print:border-none print:p-0">
        <div className="flex justify-between items-start border-b pb-8 mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500">Pure, Natural, Organic</p>
          ...
          <div className="text-right">
            ...
            <p className="text-sm"><span className="font-semibold">Date:</span> {order.createdAt.toLocaleDateString()}</p>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t text-center text-sm text-gray-500">
          <p>Thank you for choosing pure, organic food from Nutty World.</p>
          <p>If you have any questions about this invoice, please contact support@nuttyworld.com</p>
        </div>
      </div>
    </div>
  );
