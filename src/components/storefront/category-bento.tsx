...
export function CategoryBento() {
  ...
  return (
    <section className="py-3 md:py-14 bg-white dark:bg-zinc-900 border-b border-zinc-200/80 dark:border-zinc-800">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-5"
        >
